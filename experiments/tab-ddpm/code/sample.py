...
def sample(
    ...
    if disbalance == 'fix':
    ...
    elif disbalance == 'fill' or balance_ratio is not None:
        ...
        for i in range(empirical_class_dist.shape[0]):
            ...
            if balance_ratio is not None:
                num_samples = max(0, int(val_major * balance_ratio) - empirical_class_dist[i].item())
    ...
    if num_numerical_features != 0 and num_numerical_features < X_gen.shape[1]:
        print("Num shape: ", X_num.shape)
